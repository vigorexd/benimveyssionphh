...
def download_update():
    try:
        ...
        update_url = "https://raw.githubusercontent.com/vigorexd/benimveyssionphh/master/yeni.py"
        response = requests.get(update_url)
        with open('yeni.py', 'wb') as file:
...
def run_update():
    try:
        ...
        subprocess.call(['python', 'yeni.py'])
        return True
    except Exception as e:
...
if __name__ == "__main__":
    current_version = "1.4"  # Uygulamanın mevcut sürümü
    if check_for_updates(current_version):
        ...
        if download_update():
            ...
            if run_update():
                ...
                os.remove('yeni.py')  # Güncellenmiş betiği sil
            else:
